...
public:	
	...
	//Take the item to represent and creates the pickup from it. Done on BeginPlay and when player drop an item on the ground.
...
protected:
	...
	//If some property of the item is modified, we bind this to OnItemModified and refresh the UI if the item gets modified
	UFUNCTION()
	void OnItemModified();
	...
	//Called when a player take the pickup
	UFUNCTION()
